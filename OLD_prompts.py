...
ALL_lists = {
    "tipos_doc": tipos_doc,
    "origens_doc": origens_doc,
    "tipos_locais": tipos_locais,
    "areas_de_atribuição": areas_de_atribuição,
    "tipos_a_autuar": tipos_a_autuar,
    "assuntos_re": assuntos_re,
    ...
    "resumo_artigos_in_270": resumo_artigos_in_270,
    "assuntos_comuns_delefaz": assuntos_comuns_delefaz,
    "assuntos_comuns_deleprev": assuntos_comuns_deleprev,
    "assuntos_comuns_delecor": assuntos_comuns_delecor,
    "assuntos_comuns_deleciber": assuntos_comuns_deleciber,
    "assuntos_comuns_delinst": assuntos_comuns_delinst,
    "assuntos_comuns_dma": assuntos_comuns_dma,
    "assuntos_comuns_delepat": assuntos_comuns_delepat,
    "assuntos_comuns_dre": assuntos_comuns_dre
}
...
prompt_C0 = {
    "role": "user","content": 
        ...
        "- Lista de tipos de documento (tipos_doc): {tipos_doc}\n\n"
        "- Lista de órgãos de origem (origens_doc): {origens_doc}\n\n"
        "- Lista de tipos de local (tipos_locais): {tipos_locais}\n\n"
        "- Lista de áreas de atribuição (areas_de_atribuição): {areas_de_atribuição}\n\n"
        "- Lista de tipos de autuação após análise inicial (tipos_a_autuar): {tipos_a_autuar}\n\n"
        "- Lista de assuntos de RE - Registro Especial (assuntos_re): {assuntos_re}\n\n"
        "- Lista de Referência Normativa para Tratamento Especial (lista_normativa_prometheus): {lista_normativa_prometheus}\n\n" 
        "- Lista de Categorias Prometheus para Tratamento Especial (materias_prometheus): {materias_prometheus}\n\n"
        "- Lista de Delegacias especializadas da SR/PF/SP (lista_delegacias_especializadas), localizadas na cidade capital São Paulo: {lista_delegacias_especializadas}\n\n"
        "- Lista de tipos de papel nos casos (tipos_envolvidos): {tipos_envolvidos}"
}
...
# Apenas para grupo único ou grupo 2:
prompt_H1 = {"role": "user", "content": "### EXEMPLOS DE RESUMO DO FATO:\n\n{exemplos_resumos}"}

# BLOCO I – INSTRUÇÕES NORMATIVAS
# Apenas para grupo único ou grupo 3:
prompt_I1 = {"role": "user", "content": "### INSTRUÇÃO NORMATIVA DG/PF Nº 270/2023 (para definição de 'DESTINAÇÃO')\n{resumo_artigos_in_270}"
             }
# Apenas para grupo único ou grupo 4:
prompt_I2 = {"role": "user", "content": "### INSTRUÇÃO NORMATIVA DG/PF Nº 255/2023 (para definição de 'TIPO A AUTUAR')\n{resumo_artigos_in_255}"
             }
...
prompt_J0 = {
    "role": "user", "content": 
        ...
        "- Exemplos mais comuns classificados como 'Crimes Fazendários' e atribuídos à Delefaz: {assuntos_comuns_delefaz}\n\n"
        "- Exemplos mais comuns atribuídos à DELEPREV: {assuntos_comuns_deleprev}\n\n"
        "- Exemplos mais comuns atribuídos à DELECOR: {assuntos_comuns_delecor}\n\n"
        "- Exemplos mais comuns atribuídos à DELECIBER: {assuntos_comuns_deleciber}\n\n"
        "- Exemplos mais comuns atribuídos à DELINST: {assuntos_comuns_delinst}\n\n"
        "- Exemplos mais comuns atribuídos à DMA: {assuntos_comuns_dma}\n\n"
        "- Exemplos mais comuns atribuídos à DELEPAT: {assuntos_comuns_delepat}\n\n"
        "- Exemplos mais comuns atribuídos à DRE: {assuntos_comuns_dre}"
}
# Grupo 3 (destinação):
prompt_J1 = {
    "role": "user", "content": 
...
ALL_prompts = {
    "system_prompt_A0": system_prompt_A0, 
    "general_instruction_B1_1": general_instruction_B1_1, 
    "general_instruction_B1_2": general_instruction_B1_2,
    "start_action_B2": start_action_B2, 
    "final_action_L0": final_action_L0, 
    "prompt_format_output_instruction": prompt_format_output_instruction,
    "prompt_C0": prompt_C0,
    "prompt_C1": prompt_C1,
    "prompt_C2": prompt_C2,
    "prompt_C3": prompt_C3,
