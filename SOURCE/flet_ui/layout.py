...
from SOURCE.flet_ui.components.components import show_snackbar, ValidatedTextField, ManagedAlertDialog
...
def show_proxy_settings_dialog(page: ft.Page) -> None:
    ...
    from SOURCE.settings import (K_PROXY_ENABLED, K_PROXY_PASSWORD_SAVED, K_PROXY_IP_URL, K_PROXY_PORT, K_PROXY_USERNAME, K_PROXY_PASSWORD,
                            PROXY_URL_DEFAULT, PROXY_PORT_DEFAULT)
    from SOURCE.config_manager import get_proxy_settings, save_proxy_settings
    from SOURCE.utils import test_connection
