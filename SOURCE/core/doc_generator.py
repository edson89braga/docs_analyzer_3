...
from SOURCE.core.prompts import formatted_initial_analysis # Para type hinting e acesso aos campos
from SOURCE.settings import ASSETS_DIR, TEMPLATES_DOCX_SUBDIR # Para acessar a pasta de assets
